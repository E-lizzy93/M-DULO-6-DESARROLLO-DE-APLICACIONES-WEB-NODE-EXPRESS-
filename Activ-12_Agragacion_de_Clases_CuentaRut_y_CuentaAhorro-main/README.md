# BancoEstado — Clases + API REST

Igual que la actividad anterior pero usando clases `CuentaRut` y `CuentaAhorro` en archivos separados.
...
├── models/
│   ├── CuentaRut.js     # Clase CuentaRut
│   └── CuentaAhorro.js  # Clase CuentaAhorro
├── package.json
└── public/
